package wg.nettime.mobileimsdk.server.netty;
 ...
 * 了）。
 * <p>
 * 本类在且仅在{@link ServerLauncher#initChildChannelHandler4Netty()}中被使用。
 * 
 * @version 1.0
 * @since 3.1
 * @see ServerCoreHandler
 * @see ServerLauncher#initChildChannelHandler4Netty()
 */
