package wg.media.screen.fm.modKit;
...
public class DBModelGenerator_datasea {
	private static DruidPlugin createDruidPlugin() {
		// return new
		// C3p0Plugin("jdbc:mysql://101.200.125.86/_newMedia_al?characterEncoding=utf8",
		// "dba", "db*#2016");
		return new DruidPlugin(
				"jdbc:mysql://10.3.80.116:3306/command_screen?characterEncoding=utf8&serverTimezone=Asia/Shanghai",
				"sprint01", "Sprint02@mysql");
	}
	...
	static String package_ = "wg.media.screen.fm.model.command_screen";
	...
	public static void main(String[] args) {
		...
		// "/../../src/main/java/"+package_.replaceAll("\\.", "/")+"/base";
		String baseModelOutputDir = PathKit.getRootClassPath() + "/../../../src/" + package_.replaceAll("\\.", "/")
				+ "/base";
