...
public class CreateNamePicture {
    ...
    public static void main(String[] args) throws IOException {
        String name = "杨芳";
        String picname="yangfang";
        generateImg(name, "D:\\touxiang", picname);
    }
    ...
    public static boolean generateImg(String name, String outputPath, String outputName)throws IOException {
    	...
    	System.out.println("#################头像名称："+name);
    	System.out.println("#################头像地址："+outputPath);
        ...
        g2.setBackground(new Color(254,113,41));
