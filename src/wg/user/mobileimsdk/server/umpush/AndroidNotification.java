...
public abstract class AndroidNotification extends UmengNotification {
	...
	//自定义参数
	//groupId是群组id。topicid是选题id。ext_url是前端的路由
	public void setGroupId(String groupId) throws Exception {
		setPredefinedKeyValue("groupId", groupId);
	}
	public void setTopicId(String topicId) throws Exception {
		setPredefinedKeyValue("topicId", topicId);
	}
	public void setExt_url(String ext_url) throws Exception {
		setPredefinedKeyValue("ext_url", ext_url);
	}
	
	//friendId是好友id。friendName是昵称。friendIcon是头像url。isGroup是否是群聊。不是1是2.topicid是群组的选题id
	public void setFriendId(String friendId) throws Exception {
		setPredefinedKeyValue("friendId", friendId);
	}
	public void setFriendName(String friendName) throws Exception {
		setPredefinedKeyValue("friendName", friendName);
	}
	public void setFriendIcon(String friendIcon) throws Exception {
		setPredefinedKeyValue("friendIcon", friendIcon);
	}
	public void setIsGroup(String isGroup) throws Exception {
		setPredefinedKeyValue("isGroup", isGroup);
	}
