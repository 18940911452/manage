package wg.user.mobileimsdk.server.image;
...
public final class ImageUtilHead {
    ...
    public static void main(String[] args) throws IOException {
    	...
    	for (int i = 0; i <11; i++) {
    		picUrls.add("D:\\touxiang\\guanli.jpg");
		}
		String dir="D:\\touxiang\\";
		System.out.println(getCombinationOfhead(picUrls,dir,"123"));
    }
     ...
     * @throws IOException
     */
    public static boolean getCombinationOfhead(List<String> pathst, String dir, String groupId)
            throws IOException {
        ...
        for (int i = 0; i < paths.size(); i++) {
            BufferedImage resize2 = ImageUtilHead.resize2(paths.get(i), imageSize, imageSize, true);
