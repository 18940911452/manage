! function(t, e) {
	...
	var s = function(t, e, a) {
		...
		var n = '<div class="daterangepicker dropdown-menu ' + s + '"><div class="ranges"><div class="range_inputs"><div class="daterangepicker_start_input"><label for="daterangepicker_start"></label><input class="input-mini" type="text" autocomplete="off" name="daterangepicker_start" value="" /></div><div class="daterangepicker_end_input"><label for="daterangepicker_end"></label><input class="input-mini" type="text" autocomplete="off"  name="daterangepicker_end" value="" /></div><button class="applyBtn" disabled="disabled"></button>&nbsp;<button class="cancelBtn"></button></div></div><div class="calendar first left"></div><div class="calendar second right"></div></div>';
	...
	s.prototype = {
		...
		setOptions: function(t, e) {
			...
			if("string" == typeof t.timeZone || "number" == typeof t.timeZone ? (this.timeZone = t.timeZone, this.startDate.utcOffset(-this.timeZone), this.endDate.utcOffset(-this.timeZone)) : this.timeZone = -a(this.startDate).utcOffset(), "object" == typeof t.ranges) {
		...
		buildCalendar: function(t, e, i, s, n, r) {
			...
			var g, y, k = a([f, d, D, 12, s, n]).utcOffset(-this.timeZone);
		...
		renderCalendar: function(t, e, a, s, n) {
			...
			r += '<table class="table-condensed">', r += "<thead>", r += "<tr>", this.showWeekNumbers && (r += "<th></th>"), r += !a || a.isBefore(t.firstDay) ? '<th class="prev available"><i class="fa fa-arrow-left "></i></th>' : "<th></th>";
			var o = this.locale.monthNames[t[1][1].month()] + t[1][1].format(" YYYY");
			this.showDropdowns && (o = this.renderDropdowns(t[1][1], a, s)), r += '<th colspan="5" class="month">' + o + "</th>", r += !s || s.isAfter(t.lastDay) ? '<th class="next available"><i class="fa fa-arrow-right"></i></th>' : "<th></th>", r += "</tr>", r += "<tr>", this.showWeekNumbers && (r += '<th class="week">' + this.locale.weekLabel + "</th>"), i.each(this.locale.daysOfWeek, function(t, e) {
				r += "<th>" + e + "</th>"
