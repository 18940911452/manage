var iPage = {
	...
	end_html: "<div class='page_end'><img style='display:block;margin:30px auto 50px auto;' src='img/nodata.png' /></div>",
	finish_html: "<div class='page_end'><img style='display:block;margin:30px auto 50px auto;' src='img/finishData.png' /></div>",
	loading_html: "<div style='padding:50px 0'><img style='display:block;margin:0 auto;' src='img/ajax-loader.gif' /></div>",
//	loading_html: "<div class='refresh-preloader' style='display:block'><div class='la-timer la-dark'><div></div></div></div>",
	more_html: "<div class='page_more'>加载更多</div>",
	ScrollLoadContainer: function(a, b, c,d) {
		this.container = $("#" + a);
		this.url = b;
...
iPage.ScrollLoadContainer.prototype.init = function() {
	...
	if(a.view){
		$(a.view).unbind("scroll").scroll(function() {
			clearTimeout(a.handle);
			if($(a.view).scrollTop() + $(a.view).height() >= a.container.find(".content_div").height() * 1) {
				if(a.isRec == 2) {
...
iPage.ScrollLoadContainer.prototype.loadMore = function() {
	var a = this;
	// if(a.total == -1 || a.total == undefined) {
	// 	a.total = a.container.find(a.pageData).data("total") 
	// }
	if (a.total) {
		if (a.pageNo>Math.ceil(a.total/a.pageSize)) {
			return 
		}
	}
...
iPage.ScrollLoadContainer.prototype.updateTip = function() {
	...
	switch(a.isRec) {
		...
		case 0:
			...
			break;
		case 1:
			$(".status_tip", a.container).html(iPage.finish_html);
			break;
		case 2:
...
iPage.ScrollLoadContainer.prototype.loadPageAfter = function() {
	...
	$(b.container).find('.status_tip').html('');
	if(b.total == -1 || b.total == undefined) {
		b.total = b.container.find(b.pageData).data("total") 
	}
	...
	if(a != null && a.length > 0) {
		...
		// 	b.isRec = 1
		// }
		if(b.pageNo>Math.ceil(b.total/b.pageSize)){
			b.isRec = 1
		}
		if(b.total == 0){
			b.isRec = -1
